...
const FEATURES = [
  { color: '#ff501e', label: 'Choose A / B / C site — smallest pool wins' },
  { color: '#66c0f4', label: 'Real-time rounds: 5 / 10 / 15 minutes' },
  { color: '#a78bfa', label: 'Provably fair — logged on TRON blockchain' },
];
    ...
    <Root>
      ...
      <Card>
        <LogoWrapper>
          ...
          <LogoText>
            Clutch<span>Stake</span>
          </LogoText>
        </LogoWrapper>

        <Heading>Sign in to play</Heading>
        <Subheading>Use your Steam account to get started. No registration required.</Subheading>

        <SteamButton href={`${API_URL}/auth/steam`}>
          <SteamIcon>
        ...
        <Footer>By signing in you agree to our Terms of Service and Privacy Policy</Footer>
      </Card>
    </Root>
  );
}
